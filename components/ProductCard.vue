...
<template>
  <div class="group transition-all duration-500">
    <nuxt-link
      ...
      class="cursor-pointer flex flex-col rounded-md relative items-center justify-between overflow-hidden md:hover-group:-translate-y-2 hover:shadow-xl hover:shadow-gray-200"
    >
