...
<template>
    ...
    <div id="sib-form-container" class="sib-form-container">
      ...
      <div id="sib-container">
        <form
          id="sib-form"
          method="POST"
          action="https://7ddd14d5.sibforms.com/serve/MUIFAA_czKpdRC3AJgF094PaXVxzEduZHktdB1mvDhRZbVl_JKjlhykrNtVCvrmsFXrrOyhEnpkAnt0RmIvC1YoeDWPKc1dGoTXplz3R8F2KynR7dCHP8ISX0m6O2__qLAGlwrJ4XLVKiCtGmnwliR5GFbLw0R7RZELnCwnrOSAyWGsr3Dim0xc0UcB0XzKG1QJ7IOnVXKUmlS3z"
  ...
  >
    ...
    <p>Subscribe to our newsletter and stay updated.</p>
    <UFormGroup label="Enter your email address to subscribe" name="email">
      <UInput
        v-model="state.email"
        type="text"
        id="EMAIL"
    ...
    <UCheckbox
      ...
      help="You may unsubscribe at any time using the link in our newsletter."
      name="terms"
      :value="state.agree"
      validation="accepted"
    ...
    <div class="flex">
      ...
      <p>
        We use Brevo as our marketing platform. By clicking below to submit this
        form, you acknowledge that the information you provided will be
    ...
    <UButton form="sib-form" type="submit" @click="onSubmit">
      SUBSCRIBE
    </UButton>
  </UForm> -->
</template>
